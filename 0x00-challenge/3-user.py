...
if __name__ == '__main__':
    ...
    user_2.password = "89"  # Changed to a valid string
    if user_2.password is not None:
        print("User.password should be None if set to a non-integer string")
    ...
    if user_1.is_valid_password("89"):
        print("is_valid_password should return False if compared with an integer string")
